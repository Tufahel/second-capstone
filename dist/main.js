...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_displayPop_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/displayPop.js */ \"./src/modules/displayPop.js\");\n/* harmony import */ var _img_pokemon_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./img/pokemon.png */ \"./src/img/pokemon.png\");\n/* harmony import */ var _modules_callApi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/callApi.js */ \"./src/modules/callApi.js\");\n/* harmony import */ var _modules_getApiDetails_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/getApiDetails.js */ \"./src/modules/getApiDetails.js\");\n/* harmony import */ var _modules_frontStructure_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/frontStructure.js */ \"./src/modules/frontStructure.js\");\n/* harmony import */ var _modules_likeDetails_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/likeDetails.js */ \"./src/modules/likeDetails.js\");\n/* harmony import */ var _modules_productCount_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/productCount.js */ \"./src/modules/productCount.js\");\n/* eslint-disable no-unused-expressions */\n\n\n\n\n\n\n\n\n\nconst load = async () => {\n  const data = await (0,_modules_callApi_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  const item = (0,_modules_productCount_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])(data.results);\n  (0,_modules_likeDetails_js__WEBPACK_IMPORTED_MODULE_6__.showItemsCount)(item);\n  await (0,_modules_getApiDetails_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(data);\n  await (0,_modules_frontStructure_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(data);\n};\n\nload();\n\n// Api section-Start\n// var\nconst popUp = document.querySelector('.pop-up');\nconst api = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/';\n\n// // GET comment Data from API\n// const getScoresList = async () => {\n//   const getScrores = await fetch(`${api}S7bgLJujc1ed84xOIncM/comments?item_id=31`);\n//   const data = await getScrores.json();\n//   displayCmnt(data);\n// };\n\n// Display comments\nconst scoresList = document.querySelector('.com-display');\n\n// const displayCmnt = (data) => {\n//   scoresList.innerHTML = '';\n//   data.forEach((item) => {\n//     scoresList.innerHTML += `<li class=\"score_and_name\">${item.username}:${item.comment}</li>`;\n//   });\n// };\n\n// Comments event listners\nwindow.subCmnt = async (e, id) => {\n  e.preventDefault();\n  const name = document.querySelector('#name').value;\n  const insights = document.querySelector('#insights').value;\n  const form = document.querySelector('.add-comment');\n  await fetch(`${api}S7bgLJujc1ed84xOIncM/comments`, {\n    method: 'POST',\n    headers: { 'Content-Type': 'application/json' },\n    body: JSON.stringify({\n      item_id: id,\n      username: name,\n      comment: insights,\n    }),\n  }).then((res) => console.log(res))\n    .catch((error) => console.log(error));\n  form.reset();\n};\n\n// show pop up\nwindow.addEventListener('click', async (e) => {\n  if (e.target.className === 'btn-cmnt') {\n    const { id } = e.target;\n    const data = await fetch(`https://pokeapi.co/api/v2/pokemon/${id}`).then((data) => data.json());\n    const comments = await fetch(`${api}S7bgLJujc1ed84xOIncM/comments?item_id=${id}`).then((data) => data.json());\n    (0,_modules_displayPop_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(data, comments);\n  }\n});\n\n// close pop up\nwindow.addEventListener('click', async (e) => {\n  if (e.target.className === 'close-btn') {\n    popUp.style.cssText = 'transform: scale(0);';\n  }\n});\n\n// Api section-End\n\n// Window onLoad\n\nwindow.onload = getScoresList();\n\n//# sourceURL=webpack://webpack-template/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _likeDetails_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./likeDetails.js */ \"./src/modules/likeDetails.js\");\n\n\nconst frontStructure = async (data) => {\n  const { name } = data;\n  const { id } = data;\n  const img = data.sprites.other['official-artwork'].front_default;\n\n  const like = await (0,_likeDetails_js__WEBPACK_IMPORTED_MODULE_0__.update)(id);\n  const gridList = document.querySelector('.grid-list');\n  gridList.innerHTML += `\n        <div class=\"grid-item\">\n        <img src=\"${img}\"/>\n        <div class=\"header-content\">\n        <h3 class=\"name\">${name}<h3>\n        <div class=\"like-details\">\n        <i id=\"btn-like\" class=\"fa fa-regular fa-heart btn-like\"></i>\n        <span id=${id}>${like}</span>\n        </div>\n        </div>\n        <button type=\"button\" class=\"btn-cmnt\" id=${id}>Comments</button>\n        </div>\n    `;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (frontStructure);\n\n\n//# sourceURL=webpack://webpack-template/./src/modules/frontStructure.js?");
...
/***/ "./src/modules/productCount.js":
/*!*************************************!*\
  !*** ./src/modules/productCount.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst productCount = (data) => {\n  const count = data.length;\n  console.log('count: ', count);\n  return count;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (productCount);\n\n//# sourceURL=webpack://webpack-template/./src/modules/productCount.js?");
...
eval("module.exports = __webpack_require__.p + \"img/pokemon.png\";\n\n//# sourceURL=webpack://webpack-template/./src/img/pokemon.png?");
